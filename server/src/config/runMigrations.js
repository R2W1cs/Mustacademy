...
export async function runMigrations() {
    ...
    try {
        ...
        `);
        console.log('[Migrations] ✓ users auth hardening columns up to date');
    } catch (err) {
        console.error('[Migrations] auth hardening migration failed:', err.message);
    }
    ...
    try {
        ...
        `);
        console.log('[Migrations] ✓ password_resets table up to date');
    } catch (err) {
        console.error('[Migrations] password_resets migration failed:', err.message);
    }
}
